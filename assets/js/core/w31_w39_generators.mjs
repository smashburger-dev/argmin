// Seeded generators for weeks 31-39 (research phase and capstone), ADR-0014
// Part 2. Same house rules as the other generator modules:
//   - mulberry32 rng, identical to w01/w05/w27_w30 generator modules;
...
const { until, clean } = bindFamilyDraw({ maxTries: 128, scope: 'w31_w39_generators' });
