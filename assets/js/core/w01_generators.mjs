...
// w05_generators.mjs: single source of truth imported by the browser graders
// AND the Node property tests (tests/w01_generators.test.mjs).
//
 ...
 *  w05_generators.mjs so seeds behave identically in browser and Node. */
