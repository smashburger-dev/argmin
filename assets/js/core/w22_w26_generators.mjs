// Seeded generators for weeks 22-26 (transformers and LLM foundations),
...
//     over 2000 seeds, enforced by tests/w22_w26_generators.test.mjs);
...
const { until, clean } = bindFamilyDraw({ maxTries: 96, scope: 'w22_w26_generators' });
