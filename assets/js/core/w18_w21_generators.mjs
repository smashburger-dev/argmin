// Seeded generators for weeks 18-21 (deep-learning core), ADR-0013.
// House rules mirror w01/w05/data_ml generators: mulberry32 rng, exact
...
// expected values over 2000 seeds, enforced by tests/w18_w21_generators
// .test.mjs), semantic variation (>= 3 prompt shapes per family), the answer
...
const { until, clean } = bindFamilyDraw({ maxTries: 96, scope: 'w18_w21_generators' });
