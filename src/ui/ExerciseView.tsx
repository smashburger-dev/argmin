...
import { getExercise, loadSources } from '../adapters/content-repository';
...
export function ExerciseView({ catalog, exerciseId }: { catalog: CatalogData; exerciseId: string }) {
  ...
  const summary = catalog.exercises.find((item) => item.definitionId === pureId);
