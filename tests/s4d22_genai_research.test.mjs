...
import { genRecallAtK, genF1orPrecision, genInjectionFlagCount, genAllowedActionCount } from '../assets/js/core/w27_w30_generators.mjs';
import { genProtocolShifts, genCardAudit, genSubgroupCost, protocolShiftFlags, countCardDefects, subgroupRatePerMille } from '../assets/js/core/w31_w39_generators.mjs';
