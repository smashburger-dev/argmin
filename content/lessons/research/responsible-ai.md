...
In [w33-e2](#/exercise/w33-e2) berechnest du Raten-Differenzen zweier Gruppen in Tausendsteln. [w33-e3](#/exercise/w33-e3) verfolgt eine RPN-Priorisierung im Code; [w33-e4](#/exercise/w33-e4) implementiert die Subgruppenmetriken; [w33-e5](#/exercise/w33-e5) kombiniert Schwellenwahl unter Paritätsband mit der Kostentabelle; der Boss [w33-e6](#/exercise/w33-e6) verweigert den Responsible-Bericht, wenn Subgruppen, Parität, Kosten oder Restrisiko fehlen.
