...
In einer Einstiegsaufgabe berechnest du Raten-Differenzen zweier Gruppen in Tausendsteln. [Code lesen und die Endwerte angeben: Eine RPN-Priorisierung (Risiko · Prävalenz …](#/family/trace-assignment-state/rpn-priority-trace/0/core) verfolgt eine RPN-Priorisierung im Code; [Implementiere die Subgruppenmetriken. subgroup_metrics(zaehlungen) erhält ein …](#/family/aggregate-confusion-metric/fairness-metric-compare/0/core) implementiert die Subgruppenmetriken; [Implementiere Schwellenwahl und Kostenrechnung. threshold_sweep(kandidaten, …](#/family/aggregate-parity-threshold-selection/parity-threshold-selection/0/stretch) kombiniert Schwellenwahl unter Paritätsband mit der Kostentabelle; der Boss [Final Boss Responsible-Report: Implementiere responsible_report(subgroups, …](#/family/validate-report-guard-compose/report-guard-compose/0/challenge) verweigert den Responsible-Bericht, wenn Subgruppen, Parität, Kosten oder Restrisiko fehlen.
