...
In einer Einstiegsaufgabe zählst du Goal-Shift-Flags zwischen zwei Protokollversionen. [Implementiere die Prüfbarkeit von Forschungsfragen. is_testable(frage) liefert …](#/family/validate-text-normalize-match/text-normalize-match/0/core) prüft Fragen auf Prüfbarkeit und zerlegt Je-desto-Hypothesen in UV und DV; [Implementiere den Protokoll-Validator. validate_protocol(p) erhält ein …](#/family/validate-required-field-raise/protocol-validator/0/stretch) validiert ein Protokoll auf Pflichtfelder und Datumreihenfolge; der Boss [Final Boss Goal-Shift-Detektor: Implementiere detect_goal_shift(v1, v2) für …](#/family/validate-goalshift-flag-rules/detect-goal-shift/0/challenge) implementiert die volle Goal-Shift-Erkennung für zwei Versionen.
