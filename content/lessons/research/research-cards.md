...
In [w32-e2](#/exercise/w32-e2) zählst du fehlende und leere Pflichtfelder über Karten hinweg. [w32-e3](#/exercise/w32-e3) verfolgt eine Feld- und Split-Prüfung im Code; [w32-e4](#/exercise/w32-e4) implementiert validate_card mit Split-Summen und Semver; [w32-e5](#/exercise/w32-e5) prüft Karten gegen das Protokoll und scannt auf geleakte Schlüssel und Token; der Boss [w32-e6](#/exercise/w32-e6) führt den Cross-Check über alle Karten und das Protokoll zu einer Widerspruchsliste zusammen.
