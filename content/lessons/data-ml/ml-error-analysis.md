...
Berechne in einer Einstiegsaufgabe eine Subgruppen-Lücke in Prozentpunkten. Klassifiziere den Fehlertyp in [Ein Defekt-Klassifikator erreicht in der Pilotphase 96 % Accuracy. Drei Monate …](#/family/classify-error-drift/accuracy-drop-without-code-change/0/core). In [Implementiere die Teilgruppen-Analyse. `subgroup_error_rates(y_true, y_pred, …](#/family/aggregate-grouped-metrics-report/subgroup-error-rates-numpy/0/core) implementierst du subgroup_error_rates und largest_gap; [Final Boss: Fehlerkategorisierung und Modellkarte. `categorize_errors(errors)` …](#/family/aggregate-grouped-metrics-report/categorize-errors-report/0/stretch) verlangt die Fehlerkategorisierung plus Modellkarten-Stub.
