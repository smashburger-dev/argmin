...
In einer Einstiegsaufgabe berechnest du Precision/F1 aus ganzzahligen Konfusionsmatrizen. [Implementiere die Regelklassifikation der Fehlertaxonomie. classify(record, …](#/family/classify-rule-cascade-priority/error-taxonomy-classify/0/core) implementiert den Klassifikator mit vorgegebenem Regelwerk plus Zitat-Precision; [Implementiere die deterministischen Metriken aus Zeilenlisten. confusion(rows): …](#/family/aggregate-confusion-metric/confusion-from-rows/0/stretch) wandelt Zeilenlisten in Konfusionsmatrizen und Metriken; der Boss [Final Boss Evaluator: Implementiere run_eval(records, rules) und …](#/family/aggregate-detector-eval-compare/run-eval-compare-rulesets/0/challenge) evaluatiert 20 Fixtur-Antworten unter zwei Regelwerken und vergleicht sie.
