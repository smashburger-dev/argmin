...
Zähle in einer Einstiegsaufgabe Masken in Ganzzahlen. Lies in [Feste Maske lesen: Was gibt dieses NumPy-Programm aus? Sage die Ausgaben der …](#/family/trace-assignment-state/fixed-dropout-mask-trace/0/core) eine feste Maske als Ausgabe vorher. In [Regularisierung exakt umsetzen. dropout_forward(x, mask, p) wendet eine feste …](#/family/optimize-training-primitive-contract/dropout-weight-decay-primitives/0/core) implementierst du Dropout-Forward und Weight-Decay-Update exakt; [Early Stopping und Save/Load. early_stop_epoch(val_losses, patience) durchläuft …](#/family/fit-early-stopping-roundtrip/early-stopping-roundtrip/0/stretch) baut Early Stopping und Save/Load, und [Final Boss faire Ablation: misst Weight Decay wirklich etwas — oder nur der …](#/family/fit-weight-decay-ablation/weight-decay-ablation/0/challenge) fährt eine faire Ablation mit fixem Seed und Split.
