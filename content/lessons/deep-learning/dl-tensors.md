...
Zähle in einer Einstiegsaufgabe Parameter eines Layers und eines kleinen MLP. Lies in [Formen lesen: Was gibt dieses NumPy-Programm aus? Sage die Ausgaben der drei …](#/family/validate-shape-contract/shapes-w18-broadcast-axes/0/core) Formen und Broadcasting ab. In [Implementiere ein lineares Layer mit Dimensionsvertrag. linear_forward(X, W, b) …](#/family/fit-forward-layer-chain-contract/linear-forward-contract/0/core) implementierst du ein lineares Layer mit Dimensionskontrolle; [Baue den Forward-Pass eines 2-Layer-MLP. mlp_forward(X, W1, b1, W2, b2) …](#/family/fit-forward-layer-chain-contract/mlp-forward-relu/0/stretch) baut den MLP-Forward mit ReLU, und [Final Boss Dimensionsverträge: Implementiere den Forward-Pass eines **beliebig …](#/family/fit-forward-layer-chain-contract/deep-forward-chain/0/challenge) verallgemeinert auf beliebig tiefe Netze mit strikten Verträgen.
