...
Rechne in einer Einstiegsaufgabe Kettenregelprodukte und Gabelungen in Ganzzahlen. Trace in [Einen manuellen Backward-Schritt nachvollziehen: Welche Werte haben grad_w, w, …](#/family/trace-assignment-state/manual-backward-step-trace/0/core) einen manuellen Backward-Schritt. In [Herleiten statt nachschlagen: Implementiere die Gradienten eines linearen …](#/family/optimize-backprop-gradient-check/linear-mse-gradients/0/core) leitest du die Gradienten eines linearen Layers her und prüfst sie numerisch; [Das volle Programm: Backpropagation für ein 2-Layer-MLP mit ReLU und MSE. …](#/family/optimize-backprop-gradient-check/mlp-backprop-relu-mse/0/stretch) verlangt das volle MLP-Backprop, und [Final Boss Autograd: ein kompletter Trainings-Teilschritt aus einer Hand. …](#/family/optimize-sgd-step-pure-update/pure-train-step/0/challenge) kombiniert Forward, Backward und SGD-Schritt zu einem Trainings-Teilschritt.
