...
Zähle in einer Einstiegsaufgabe Vokabulargrößen nach. Lies in [Encode lesen: Was gibt dieses Programm aus? Sage beide print-Zeilen vorher, …](#/family/trace-assignment-state/char-encode-roundtrip-trace/0/core) einen Encode-Ablauf vorher. In [Zeichen-Tokenizer mit Marker: Implementiere encode(text) und decode(ids) auf …](#/family/transform-tokenize-roundtrip/char-encode-roundtrip/0/core) baust du Encode/Decode mit Round-Trip-Garantie; [BPE anwenden: Implementiere bpe_encode(word, merges). Vertrag: Das Wort startet …](#/family/transform-bpe-merge-apply/bpe-merge-apply/0/stretch) wendet eine feste Mergetabelle an; [Final Boss BPE-Lernen: Implementiere learn_merges(corpus, num_merges) mit …](#/family/optimize-bpe-merge-learn/bpe-merge-learn/0/challenge) lernt Merges mit gepinntem Tie-Break — der Endgegner der Lektion.
