# Checkpoint: Toy-Inferenz

Fragen zum Selbsttest:

1. In welcher Reihenfolge prüft die Greedy-Schleife `max_len` und `eos` — und was steht in der Tokenfolge, wenn das Modell bei Schritt 5 von 7 `<eos>` ausgibt?
